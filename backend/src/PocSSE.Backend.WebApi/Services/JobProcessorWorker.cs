        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    NotificationQueue.Publish(job.ClientId, new QueuedNotification("JobStarted", jobStartedData));
                    ...
                    NotificationQueue.Publish(job.ClientId, new QueuedNotification("JobCompleted", jobCompletedData));
                ...
                catch (Exception e)
                {
                    ...
                    NotificationQueue.Publish(clientId, new QueuedNotification("JobFailed", jobFailedData));
                }                
            }
        }
    }
